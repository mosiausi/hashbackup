...
def get_user_input():
    ...
    print("   Example: /Users/lnayman/Desktop/House/")
    ...
    print("   1. Local folder (on this computer)")
    print("   2. Remote NAS via SSH")
    dest_choice = input("   Choose (1 or 2): ").strip()
    ...
    if dest_choice == "2":
        ...
        destination = input("\n   Remote folder path (e.g., /volume1/backups/): ").strip()
    else:
        print("\n" + "-"*60 + "\n")
